...
export default function HomeHero({ blok }) {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute -left-10 top-24 size-40 rounded-full bg-accent/60"
        aria-hidden
      />

      <div
        className="pointer-events-none absolute right-10 top-10 size-24 rounded-full bg-secondary/40"
        aria-hidden
      />
